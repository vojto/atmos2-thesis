...
\harvarditem{Cloud Computing: Principles and Paradigms}{2011}{cloud_book}
BUYYA, R., 2011 \emph{Cloud Computing: Principles and Paradigms}

\harvarditem{iPhone and iPad in action}{2012}{iphone_ipad_book}
TREBITOWSKI, B., 2010 \emph{iPhone and iPad in action}

\harvarditem{A history of HTML}{1998}{html_history}
RAGGET, D., 1998 \emph{A history of HTML}
\newblock [Online, accessed 1.5.2012]
\url{http://www.w3.org/People/Raggett/book4/ch02.html}

\harvarditem{JavaScript Bible}{2012}{javascript_bible_book}
GOODMAN, D., 2010 \emph{JavaScript Bible}

\harvarditem{Typekit}{2012}{typekit}
Typekit \emph{Typekit}
\newblock [Online, accessed 1.5.2012]
\url{https://typekit.com/}

\harvarditem{Google Webfonts}{2012}{google_webfonts}
Google, Inc. \emph{Google Webfonts}
\newblock [Online, accessed 1.5.2012]
\url{http://www.google.com/webfonts}

\harvarditem{Cocoa Programming for Mac OS X}{2008}{cocoa_hilegass}
HILLEGASS, A., 2008 \emph{Cocoa Programming for Mac OS X}

\harvarditem{Node: Up and Running: Scalable Server-Side Code with JavaScript}{2012}{nodejs_book}
HUGHES-CROUCHER, T., 2012 \emph{Node: Up and Running: Scalable Server-Side Code with JavaScript}

\harvarditem{Firebase Raises \$1.1M For Real-Time App Infrastructure}{2012}{firebase_funding}
HA, A., 2012 \emph{Firebase Raises \$1.1M For Real-Time App Infrastructure}
\newblock [Online, accessed 23.5.2012]
\url{http://techcrunch.com/2012/05/22/firebase-funding/}